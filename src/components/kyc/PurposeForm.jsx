...
class PurposeForm extends React.Component {
  ...
  handleSubmit(event) {
    console.log("CREDIT_STATE_SELECT");
    store.dispatch(setCreditState(CREDIT_STATE['CREDIT_STATE_SELECT']))
  }
      ...
      <div>
        <div className="row">
          <div className="col-sm-12 col-md-8 headerTextImportId">
            <h2>
              Step 1 - Funding purpose and values: {this.state.yourPurpose}
            </h2>
          </div>
        </div>
          ...
          <div class="col-sm-12 col-md-12">
            <form onSubmit={this.handleSubmit}>
              <div class="form-group">
                ...
                <select class="form-control" name="yourPurpose" required onChange={this.handleChangeIdt}>
                  <option value="" selected disabled>Select the purpose</option>
                  <option value="NewCar">
                    New Car
                  </option>
                ...
                <select class="form-control" required>
                  <option value="" selected disabled>Select how often you like to receive</option>
